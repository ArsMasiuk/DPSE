...
CColorButtonEditor::CColorButtonEditor(QColorComboBox *colorComboEditor, CColorProperty *property)
    : TButtonBasedEditor<QColorComboBox>(colorComboEditor)
{
    m_property = property;

	connect(m_hostedEditor, SIGNAL(activated(QString)), this, SLOT(onPicked(QString)));
}


void CColorButtonEditor::onEditButtonActivated()
{
...
void CColorButtonEditor::onPicked(QString)
{
	m_property->finishEdit();
}
